...
class AuthService {
  ...
  /**
   * Login an approved player.
   *
   * Password verification will be connected
   * to the authentication hashing layer.
   */
  login(
    username: string,
    passwordHash: string
  ...
  /**
   * Check whether a player is logged in.
   */
  isLoggedIn(): boolean {
    return (
